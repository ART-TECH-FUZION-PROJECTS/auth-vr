...
(function () {
      ...
      fetch(authme_admin.ajax_url, {
        ...
        .then((result) => {
          ...
          if (result.success && result.data.available) {
            ...
            msg.textContent =
              result.data.message || "Username is already taken";
  ...
  function handleUpdate() {
    ...
    const username = document
      .getElementById("authme-user-v-username")
      .value.trim();
    const email = document.getElementById("authme-user-v-email").value.trim();
    const fullname = document
      .getElementById("authme-user-v-fullname")
      .value.trim();
  ...
  document.addEventListener("DOMContentLoaded", () => {
    ...
    document
      .getElementById("authme-user-v-avatar-edit-btn")
      ?.addEventListener("click", openMediaLibrary);
    ...
    document
      .getElementById("authme-user-v-toggle-pass")
